...
const benefits = ["Access to a diverse pool of motivated students", "Brand visibility across our platforms and events", "Opportunities to shape curriculum and content", "Direct engagement with under-resourced communities", "Recognition as a leader in educational equity", "Collaborative programming and workshop opportunities"];
const PartnersPage = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
