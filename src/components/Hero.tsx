      ...
      <div className="container relative z-20 mx-auto px-4 py-24 flex-1 flex items-center">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary-foreground/90">Student-Led Initiative</span>
          </motion.div>
          ...
          >
            ...
            Take Their{" "}
            <span className="italic text-primary-foreground/90">Next Steps</span>
          </motion.h1>
              ...
              {[...universities, ...universities, ...universities, ...universities].map((uni, index) => (
                ...
                >
                  <img
                    src={uni.logo}
                    alt={`${uni.name} logo`}
                    className="max-h-14 max-w-[130px] object-contain opacity-80 hover:opacity-100 transition-opacity duration-300 grayscale hover:grayscale-0"
                  />
                </div>
              ))}
            </motion.div>
